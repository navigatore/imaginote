...
private:
    ...
    void addTone(PresentationParams::WaveType waveType, int16_t *buf, const unsigned int buf_len, float freq, float amp);
    void addSinusoidalTone(int16_t *buf, const unsigned int buf_samples, float freq, float amp);
    void addTriangularTone(int16_t *buf, const unsigned int buf_samples, float freq, float amp);
